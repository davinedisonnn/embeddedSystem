...
while i<101:
    ...
    a = 1.0 + ((0.0005)/radiusValue)
    b = (-2.0 - ((0.0005/radiusValue)))
    c = 1.0
    d = -0.0025
    ...
    #-----------------------------
    #xiMin1Arr = numpy.append([xiMin1Arr],[a])
    #xiArr = numpy.append([xiArr],[b])
    #xiPls1Arr = numpy.append([xiPls1Arr],[c])
    #-----------------------------
    """
